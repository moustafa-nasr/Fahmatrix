...
public class HeadAndTail {
    /* 
     * Windows Only
     * javac -cp ".\build\libs\fahmatrix-0.1.0.jar" .\examples\HeadAndTail.java
     * java -cp ".\build\libs\fahmatrix-0.1.0.jar;examples" HeadAndTail
     *
     */
    ...
    public static void main(String[] args) {
        ...
        csv2.readCSV(".\\examples\\small_data.csv");
        csv2.tail().print();
