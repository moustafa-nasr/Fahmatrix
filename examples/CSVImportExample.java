...
public class CSVImportExample {
    /* 
     * Windows Only
     * javac -cp ".\build\libs\fahmatrix-0.1.3.jar" .\examples\CSVImportExample.java
     * java -cp ".\build\libs\fahmatrix-0.1.3.jar;examples" CSVImportExample
     * 
     * for large datasets > 100K rows 
     * java -Xms512M -Xmx1024M -cp ".\build\libs\fahmatrix-0.1.3.jar;examples" CSVImportExample
     */
