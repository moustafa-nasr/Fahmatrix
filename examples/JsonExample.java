...
public class JsonExample {
    /* 
     * Windows Only
     * javac -cp ".\build\libs\fahmatrix-0.1.6.jar" .\examples\JsonExample.java
     * java -cp ".\build\libs\fahmatrix-0.1.6.jar;examples" JsonExample
     * 
     * for large datasets > 100K rows 
     * java -Xms512M -Xmx1024M -cp ".\build\libs\fahmatrix-0.1.6.jar;examples" JsonExample
     */
